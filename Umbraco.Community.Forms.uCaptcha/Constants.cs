namespace Umbraco.Community.Forms.uCaptcha
{
    public class Constants
    {
        public const string ApiName = "umbracocommunityformsucaptcha";
        ...
        public static string AssetsPath => "~/App_Plugins/UmbracoCommunityFormsuCaptcha/assets/";
