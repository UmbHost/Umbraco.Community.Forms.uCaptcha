...
{
    public class UmbracoCommunityFormsuCaptchaApiComposer : IComposer
    {
        public void Compose(IUmbracoBuilder builder)
        {
            ...
            builder.Services.Configure<SwaggerGenOptions>(opt =>
            {
                ...
                {
                    Title = "Umbraco Community Formsu Captcha Backoffice API",
                    Version = "1.0",
                ...
                opt.OperationFilter<UmbracoCommunityFormsuCaptchaOperationSecurityFilter>();
            });
        }

        public class UmbracoCommunityFormsuCaptchaOperationSecurityFilter : BackOfficeSecurityRequirementsOperationFilterBase
        {
        ...
        public class CustomOperationHandler : OperationIdHandler
        {
            ...
            {
                return controllerActionDescriptor.ControllerTypeInfo.Namespace?.StartsWith("Umbraco.Community.Forms.uCaptcha.Controllers", comparisonType: StringComparison.InvariantCultureIgnoreCase) is true;
            }
